...
struct ItemDefinition
{
    ...
    std::optional<core::ResourceLocation> model;
    std::vector<std::pair<std::string, std::string>> placementProperties;
};
...
public:
    ...
    [[nodiscard]] ItemDefinition* mutableItem(
        const core::ResourceLocation& name
    ) noexcept;
    [[nodiscard]] std::optional<ItemType> legacyItem(
        const core::ResourceLocation& name
    ) const noexcept;
    [[nodiscard]] std::optional<ItemType> itemType(
        const core::ResourceLocation& name
    ) const noexcept;
    [[nodiscard]] const core::ResourceLocation* itemName(
        ItemType legacyType
    ) const noexcept;
    [[nodiscard]] const core::ResourceLocation* itemModel(ItemType item) const noexcept;
    [[nodiscard]] std::optional<BlockState> itemBlockState(
        ItemType item, std::uint16_t damage = 0) const;
